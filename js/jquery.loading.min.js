    ...
    , function(t, e, n) {
        ...
        o.a.extend(r.prototype, {
            ...
            createOverlay: function() {
                ...
                return e && t.attr("id", e + "_loading-overlay"),
                t
            },
        ...
        o.a.fn.loading = function(t) {
            return this.each(function() {
                ...
                e ? void 0 === t ? e.start() : "string" == typeof t ? e[t].apply(e) : (e.destroy(),
                o.a.data(this, s, new r(o()(this),t))) : void 0 !== t && "object" != typeof t && "start" !== t && "toggle" !== t || o.a.data(this, s, new r(o()(this),t))
            })
        }
        ,
        o.a.fn.Loading = function(t) {
            var e = o()(this).data(s);
            return e && void 0 === t || o()(this).data(s, e = new r(o()(this),t)),
            e
        }
        ,
        ...
        t.exports = function(t) {
            ...
            e.i = function(t, n) {
                ...
                for (var s = 0; s < t.length; s++) {
                    var a = t[s];
                    null != a[0] && i[a[0]] || (n && !a[2] ? a[2] = n : n && (a[2] = "(".concat(a[2], ") and (").concat(n, ")")),
                    e.push(a))
                }
            }
            ,
            ...
            for (var n = 0; n < t.length; n++) {
                ...
                if (r) {
                    ...
                    for (; s < i.parts.length; s++)
                        r.parts.push(v(i.parts[s], e))
                } else {
                    for (var a = []; s < i.parts.length; s++)
                        a.push(v(i.parts[s], e));
                    o[i.id] = {
                        id: i.id,
                        refs: 1,
                        parts: a
